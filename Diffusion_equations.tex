...
% aIYaGmaaaaaOGaey4kaScapaqaa8qadaGadaqaamaalaaapaqaa8qa
...
\begin{equation}
\frac{{{\psi _{\text{1}}}}}{{{{\tilde L}_{{\text{ext}}}}}} - \gamma C{\left. {\frac{{\partial \psi }}{{\partial \rho }}} \right|_{\rho  = 1}} = \frac{1}{{{{\tilde L}_{{\text{ext}}}}}}\left( {{{\tilde \psi }_{\text{1}}} + \psi _{\text{0}}^{{\text{ext}}} - \tilde \psi _{\text{0}}^{{\text{ext}}}} \right) + {\tilde I_{\text{p}}}.
\end{equation}
