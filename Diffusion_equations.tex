...
1D Hermite elements are polynomials $\Phi_i\left(\xi\right)$,
for which
% MathType!MTEF!2!1!+-
% feaagKart1ev2aaatCvAUfKttLearuqr1ngBPrgarmqr1ngBPrgitL
% xBI9gBamXvP5wqSXMqHnxAJn0BKvguHDwzZbqegm0B1jxALjhiov2D
...
% frVkFHe9pgea0dXdar-Jb9hs0dXdbPYxe9vr0-vr0-vqpWqaaeaabi
% GaciaacaqabeaadaabauaaaOqaauaabeqaceaaaeaaqaaaaaaaaaWd
% biabfA6agnaaDaaaleaacqWGPbqAaeaadaqadaWdaeaacqWGQbGAa8
% qacaGLOaGaayzkaaaaaOWaaeWaa8aabaWdbiabicdaWaGaayjkaiaa
% wMcaaiabg2da9iabes7aK9aadaWgaaWcbaWdbiabdMgaPjabdQgaQb
% WdaeqaaaGcbaWdbiabfA6agnaaDaaaleaacqWGPbqAaeaadaqadaWd
% aeaacqWGQbGAa8qacaGLOaGaayzkaaaaaOWdamaabmaabaGaeyySae
% RaeGymaedacaGLOaGaayzkaaGaeyypa0JaeGimaadaaaaa!5C38!
\[\begin{array}{*{20}{c}}
  {\Phi _i^{\left( j \right)}\left( 0 \right) = {\delta _{ij}}} \\ 
  {\Phi _i^{\left( j \right)}\left( { \pm 1} \right) = 0} 
\end{array}\]
where $\xi$, $- 1 \leqslant \xi  \leqslant 1$ is a normalized coordinate,
the superscript $^{\left( j \right)}$ denotes the $j^{\rm th}$
derivative and $\delta$ is the Kronecker symbol.
As such, the coefficients $F_{ij}$ in the finite element reprosentation of
a function $f$,
% MathType!MTEF!2!1!+-
% feaagKart1ev2aaatCvAUfKttLearuqr1ngBPrgarmqr1ngBPrgitL
% xBI9gBamXvP5wqSXMqHnxAJn0BKvguHDwzZbqegm0B1jxALjhiov2D
...
% Vq0xXdbba91rFfpec8Eeeu0xXdbba9frFj0-OqFfea0dXdd9vqaq-J
% frVkFHe9pgea0dXdar-Jb9hs0dXdbPYxe9vr0-vr0-vqpWqaaeaabi
% GaciaacaqabeaadaabauaaaOqaaabaaaaaaaaapeGaemOzayMaeyyp
% a0Zaaabqa8aabaWdbiabdAeag9aadaWgaaWcbaWdbiabdMgaPjabdQ
% gaQbWdaeqaaOGaeuOPdy0aaSbaaSqaaiabdMgaPjabdQgaQbqabaaa
% peqabeqaniabggHiLdaaaa!4E54!
\[f = \sum {{F_{ij}}{\Phi _{ij}}} \]
are directly the values of the $j^{\rm th}$
derivatives of $f$ at a mesh point $i$.
(Two indeces are used for being more explicit; a renumbering
to a single index is straghtforward.)
...
% Vq0xXdbba91rFfpec8Eeeu0xXdbba9frFj0-OqFfea0dXdd9vqaq-J
% frVkFHe9pgea0dXdar-Jb9hs0dXdbPYxe9vr0-vr0-vqpWqaaeaabi
% GaciaacaqabeaadaabauaaaOqaaiabfA6agnaaBaaaleaacqaIWaam
% aeqaaOWaaeWaaeaacqaH+oaEaiaawIcacaGLPaaacqGH9aqpdaqada
% qaamaaemaabaGaeqOVdGhacaGLhWUaayjcSdGaeyOeI0IaeGymaeda
% caGLOaGaayzkaaWaaWbaaSqabeaacqaIYaGmaaGcdaqadaqaaiabik
% daYmaaemaabaGaeqOVdGhacaGLhWUaayjcSdGaey4kaSIaeGymaeda
% caGLOaGaayzkaaaaaa!5AA8!
\[{\Phi _0}\left( \xi  \right) = {\left( {\left| \xi  \right| - 1} \right)^2}\left( {2\left| \xi  \right| + 1} \right)\]
% MathType!MTEF!2!1!+-
% feaagKart1ev2aaatCvAUfKttLearuqr1ngBPrgarmqr1ngBPrgitL
% xBI9gBamXvP5wqSXMqHnxAJn0BKvguHDwzZbqegm0B1jxALjhiov2D
% aeHbuLwBLnhiov2DGi1BTfMBaebbfv3ySLgzGueE0jxyaibaiKc9yr
% Vq0xXdbba91rFfpec8Eeeu0xXdbba9frFj0-OqFfea0dXdd9vqaq-J
% frVkFHe9pgea0dXdar-Jb9hs0dXdbPYxe9vr0-vr0-vqpWqaaeaabi
% GaciaacaqabeaadaabauaaaOqaaiabfA6agnaaBaaaleaacqaIXaqm
...
% aadaahaaWcbeqaaiabikdaYaaaaaa!561B!
\[{\Phi _1}\left( \xi  \right) = \xi {h_i}{\left( {\left| \xi  \right| - 1} \right)^2}\]
...
\begin{enumerate}
	...
	\item Perhaps, a finite element G-S solver (CEDRES++) migh use $p$ and $F^2$ instead of $p'$ and $FF'$.
\end{enumerate}